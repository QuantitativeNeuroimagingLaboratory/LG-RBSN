...
function [methods lddmmoptions optimoptions] = setupLDDMM_hengda(moving,fixed,lddmmoptions,varargin)
...
methods.getInitialData = getPointLDDMMInitialData_hengda(moving,fixed,lddmmoptions);
