...
energyweight = lddmmoptions.energyweight;
    ...
    function [res,Gt,gt] = ltransport(x, points, varargin)
        backwards = false;
        ...
        Gt = pointPath(x,tend); % rhot is a solver structure % moving also involved -> solving evolution equation
        ...
        if order == 0
            [g1 gt] = shootgrid(g0,Gt,lddmmoptions,backwards,tend);
        else
